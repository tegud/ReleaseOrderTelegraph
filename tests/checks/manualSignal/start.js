...
describe('manual signal polling', () => {
    ...
    it('reason is set to last manual set entry for the day ', () => {
        fakeMoment.setDate('2016-03-14T09:00:01');
        ...
        return manualSignal.start().then(() => manualSignal.getState())
            .should.eventually.eql({ signal: 'red', reason: "ARGH, STOP!" });
    });

    it('setBy is set to last manual set entry for the day ', () => {
        fakeMoment.setDate('2016-03-14T09:00:01');
    ...
    it('setUntil is set to last manual set entry for the day ', () => {
        fakeMoment.setDate('2016-03-14T08:00:01');
